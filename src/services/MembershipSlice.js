...
export const getAllMembership = createAsyncThunk("allMembership", async () => {
  try {
...
const MemberShipSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(getAllMembership.pending, (state, action) => {
      state.isLoader = true;
    });
    ...
    builder.addCase(getAllMembership.rejected, (state, action) => {
      state.isLoader = false;
      state.isError = true;
    });
  },
